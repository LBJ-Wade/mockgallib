...
setup(name='mockgallib',
      ...
      py_modules=['mockgallib.power', 'mockgallib.const', 'mockgallib.sigma',
                  ...
                  'mockgallib.corr_multipole',
                  'mockgallib.minimise', 'mockgallib.comm',
                  'mockgallib.callback',
      ],
      ext_modules=[
          Extension('mockgallib._mockgallib',
                    ['py_package.cpp', 'py_msg.cpp', 'py_const.cpp',
                     ...
                     'py_sigma.cpp', 'py_mf.cpp', 'py_mf_cumulative.cpp',
                     'py_hod.cpp',
                     ...
                     'py_corr_projected.cpp', 'py_corr_multipole.cpp',
                     'py_minimise.cpp',
                     'py_comm.cpp', 'py_array.cpp', 'py_callback.cpp',
                    ],
